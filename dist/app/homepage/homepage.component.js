System.register(["@angular/core", "@angular/router", "@angular/http", "../teacher/teacher.component", "../admin/admin.component", "../user/user.component"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, http_1, teacher_component_1, admin_component_1, user_component_1;
            ...
            HomepageComponent = (function () {
                ...
                HomepageComponent.prototype.getData = function () {
                    ...
                    this.http.get('/' + '/availtest')
                        .toPromise()
                        .then(function (response) { return that.availTest = response.json().data; })
                ...
                HomepageComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [router_1.ROUTER_DIRECTIVES, admin_component_1.AdminComponent, teacher_component_1.TeacherComponent, user_component_1.UserComponent]
                    }), 
